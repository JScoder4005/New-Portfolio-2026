  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-white/10 px-8 py-6 md:w-[450px] glass"
            key={item.name + idx}
          >
            <blockquote>
              <div
              ...
              {item.icon && (
                <div className="mb-4 flex items-center justify-center text-6xl">
                  {item.icon}
                </div>
              )}
